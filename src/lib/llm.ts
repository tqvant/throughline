...
- Covered California (ACA marketplace) premium subsidies: roughly 138%-400% FPL based on PROJECTED ANNUAL income; above 400% you can still enroll at full price (whether any subsidy applies above 400% depends on the rules in effect for the coverage year — do not promise an 8.5% cap). Losing job-based coverage opens a 60-day Special Enrollment Period.
